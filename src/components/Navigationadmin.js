...
const btnDrawer = (props) => {
  ...
  return (
    <TouchableOpacity style={{ paddingLeft: 20 }}>
      <Icon type="FontAwesome" style={{color: "#fff"}} name="bars" onPress={() => props.navigation.openDrawer()} />
    </TouchableOpacity>
  )
}
  ...
  return (
    <NavigationContainer ref={navigationRef} theme={isEnabled ? DarkTheme : DefaultTheme} >
      ...
      <Drawer.Screen name="Splash" component={Splash} />
        <Drawer.Screen name="Perfil" component={StackNavigatorPerfilAdmin}  />
        <Drawer.Screen name="Complejos" component={StackNavigatorComplejos} />
