...
stripe.setOptions({
  publishableKey:
    'pk_test_51HKPhDHBXfvF0l60R4RBbwKUqgcAUaPGCbeSo9Bpw5g4RrolVqmDDif8SFQKYieK3KaoyeKsSN3NzoNW18TiNFjb00m6MSZdKz',
});
...
console.log(props)
  const handleCardPayPress = async () => {
    try {
      setLoading(true);
      setToken(null);
      const token1 = await stripe.paymentRequestWithCardForm({
